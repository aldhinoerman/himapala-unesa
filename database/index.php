...
<header id="header" class="header header-hide">
		...
		<nav id="nav-menu-container">
			...
			<li class="menu-active"><a href="../index.php#divisi">Divisi</a></li>
...
$query = "select id_data, nama_data, tgl_data, file_data from data_db order by id_data DESC LIMIT $mulai, $halaman";
}
...
?>
				<div class="col-md-6 col-lg-4">
            		...
            		<div class="content-blog">
              		...
              		<a class="pull-right btn" style="color:#71c55d"href="download.php?filename=<?=$data['file_data'];?>"><i class="fa fa-download">Download</i></a>
            		</div>
          		</div>
        	</div>
<?php
