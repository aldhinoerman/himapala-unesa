...
$query = "select id_podcast,judul_podcast,deskripsi_podcast,tgl_podcast,gambar_podcast,file_podcast from podcast order by tgl_podcast DESC LIMIT $mulai, $halaman";
}
?>
...
============================--> 
	<section id="formposting" class="padd-section wow fadeInUp">
		...
		<div class="container">
			<form action="proses_podcast.php" method="post" enctype="multipart/form-data">
				<div class="form-group">
					<label for="judul_podcast"><span>Judul</span></label>
					<input type="text" id="judul_podcast" name="judul_podcast" placeholder="Judul Podcast" class="form-control">
				</div>
				
				<div class="form-group">
      				<label for="deskripsi_podcast"><span>Deskripsi</span></label>
      				<textarea id="editor1"name="deskripsi_podcast" class="form-control"></textarea>
	...
	CKEDITOR.replace('editor1', {
		filebrowserImageBrowseUrl : 'kcfinder'
				...
				<div class="form-group">
					...
					<input type="file" name="podload" id="nama_file" class="form-control-file">
				</div><br><br>
