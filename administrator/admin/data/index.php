	...
	<header id="header" class="header header-hide">
    	<div class="container">
      	...
      	<nav id="nav-menu-container">
			...
			<li class="menu-active"><a href="#">Database</a></li>
...
$query = "select id_data,nama_data,tgl_data,file_data from data_db order by tgl_data DESC LIMIT $mulai, $halaman";
}
?>
...
?> 			
			<tr bgcolor="#ddd">
			<td align="center"><?php echo $data['id_data'];?></td>
            <td align="center"><?php echo $data['nama_data']; ?></td>
            <td align="center"><?php echo $data['tgl_data']; ?></td>
			<td>
			<div class="table-btn" align="center">
			<a href="hapus_data.php?id=<?php echo $data['id_data']; ?>" onClick = "return confirm('Apakah Anda ingin menghapus data <?php echo $data['id_data']; ?>?')" class="btn btn-primary"> Hapus </a><a href="../../../database/index.php?id=<?php echo $data['id_data']; ?>" class="btn btn-primary" target="_blank">Lihat Database</a>
			</div>
			</td>
			</tr>
<?php
	...
	<section id="formposting" class="padd-section wow fadeInUp">
		...
		<div class="container">
			<form action="proses_data.php" method="post" enctype="multipart/form-data">
				<div class="form-group">
					<label for="nama_data"><span>Nama Data</span></label>
					<input type="text" id="nama_data" name="nama_data" placeholder="Isi Nama Data" class="form-control">
				</div>
				
				<div class="form-group">
					<label for='file_data'><span>File</span></label>
					<input type="file" name="fupload" id="file_data" class="form-control-file">
				</div><br><br>
