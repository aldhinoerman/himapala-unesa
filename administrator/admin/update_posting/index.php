...
?>    
			...
			<a href="hapus_berita.php?id=<?php echo $data['id_berita']; ?>" onClick = "return confirm('Apakah Anda ingin menghapus data <?php echo $data['id_berita']; ?>?')" class="btn btn-primary"> Hapus </a><a href="edit_berita.php?id=<?php echo $data['id_berita']; ?>#formposting" class="btn btn-primary">Edit</a><a href="../../../artikel/readmore.php?id=<?php echo $data['id_berita']; ?>" class="btn btn-primary" target="_blank">Lihat Artikel</a>
			</div>
			</td>
			</tr>
<?php
	...
	<section id="formposting" class="padd-section wow fadeInUp">
		...
		<div class="container">
			<form action="proses_berita.php" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					<label for="divisi"><span>Label Artikel</span></label>
				</div>
				<div class="form-check form-check-inline">
					<input type="radio" id="divisi" name="label" value="Divisi" class="form-check-input">
					<label class="form-check-label" for="divisi">Artikel Divisi</label>
				</div>
				<div class="form-check form-check-inline">
					<input type="radio" id="umum" name="label" value="Umum" class="form-check-input">
					<label class="form-check-label" for="umum">Artikel Umum</label>
				</div>
				
				<div class="form-group">
					<label for="judul_berita"><span>Judul</span></label>
					<input type="text" id="judul_berita" name="judul_berita" placeholder="Judul Artikel" class="form-control">
				</div>
				<div class="form-group">
      				<label for="isi_berita"><span>Isi Artikel</span></label>
      				<textarea id="editor1"name="isi_berita" class="ckeditor"></textarea>
<script type="text/javascript">
	CKEDITOR.replace('editor1', {
		filebrowserImageBrowseUrl : 'kcfinder'
				...
				<div class="form-group">
					<label for='gambar'><span>Gambar Header</span></label>
